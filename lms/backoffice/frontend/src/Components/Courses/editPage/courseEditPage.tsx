...
import { Button, Image, Input, Select, Spin, Tag, notification } from "antd";
...
import ViewFields from "../viewPage/viewFields";
import EditFields from "../viewPage/editFields";
const { TextArea } = Input;

const CourseEditPage = ({ chapterId, setIsEdit, isEdit }: any) => {
        ...
        <div className="content_edit_page_container">
          <div className="content_edit_page_box">
            ...
            <div className="content_edit_video_box">
              <Image src={chapterData?.coverImage} width={440} height={120} />
            </div>
